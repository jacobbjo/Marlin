...
#define STRING_CONFIG_H_AUTHOR "(hallonhatt, SKR V1.4 TURBO Haribo)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "MK3S Haribo"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "06367ae6-3420-43db-b520-a5072b1ebe10"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // SKR 1.4 Haribo
    ...
    #define DEFAULT_Kp_LIST {  16.42,  16.42 }
    #define DEFAULT_Ki_LIST {   1.04,   1.04 }
    #define DEFAULT_Kd_LIST {  64.67,  64.67 }
  #else
...
#define Z_PROBE_FEEDRATE_FAST 3200
...
#define HOMING_FEEDRATE_MM_M { (50*60), (50*60), 800 }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MAX_POS - 30), (Y_MIN_POS + 20), 20 }
